...
const ABTestNode = memo(function ABTestNode({
  ...
  return (
    <BaseNode className="warning-tape-border relative max-w-[600px] min-w-[200px] rounded-md ring-0 backdrop-blur-sm transition-all">
      <div className="warning-tape-inner bg-purple-50">
        {appendixVisible && (
        ...
        <BaseNodeHeader>
          <BaseNodeHeaderTitle className="flex items-center gap-2">
            <div className="flex size-8 items-center justify-center rounded-full border border-green-600 bg-emerald-100">
